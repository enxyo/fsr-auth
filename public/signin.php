...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $auth_password_hash = password_hash($password, PASSWORD_BCRYPT, $options);
    ...
    // Insert into DB
    $statement = $pdo->prepare("INSERT INTO fsr_auth (fsr_auth.email,fsr_auth.auth_password_hash,fsr_auth.status,fsr_auth.ipb3_password_hash,fsr_auth.ipb3_password_salt,fsr_auth.legacy) VALUES (?,?,?,?,?,?)");
